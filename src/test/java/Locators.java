...
public class Locators extends Functions {
    ...
    public static final By ITEM_TITLE = AppiumBy.id("pdp_title_text");
    ...
    public static final By PRIVACY_POPUP = AppiumBy.id("onetrust-policy-title");
    ...
    public static final By ADD_TO_CART_BTN = AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" + ".scrollIntoView(new UiSelector().resourceId(\"pdp_button_section_add_to_cart\")");
    ...
    public static final By INCREASE_ITEM_QTY = AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" + ".scrollIntoView(new UiSelector().description(\"Increase quantity by 1\")");
    public static final By DECREASE_ITEM_QTY = AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true))" + ".scrollIntoView(new UiSelector().description(\"Decrease quantity by 1\")");
